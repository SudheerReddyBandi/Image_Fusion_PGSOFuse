...
% figure(8), imshow((F6),[]);
% figure(9), imshow((F3),[]);
imwrite(F,gray,fuse_path,'png');
imwrite(F1,gray,fuse_path,'png');
imwrite(F2,gray,fuse_path,'png');
imwrite(F3,gray,fuse_path,'png');
imwrite(F4,gray,fuse_path,'png');
imwrite(F5,gray,fuse_path,'png');
imwrite(F6,gray,fuse_path,'png');
end
